...
import { Dropzone, FileMosaic, type ExtFile } from "@dropzone-ui/react";
...
export default function Home() {
  ...
  function getLocation() {
    const returnPosition = (position: { coords: { latitude: number; longitude: number; }; }) => {
        ...
        <div className="lg:mx-[16rem] xl:mx-[28rem] py-[4rem] bg-white">
          ...
          <form className="px-[5rem]">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-4 mt-[4rem]">
              ...
              <div className="xl:col-span-12">
                <label>
                  ...
                  <Dropzone onChange={updateFiles} maxFiles={8} maxFileSize={31460000} accept="image/*" value={files}>
                    {files.map((file, ind) => (
                      <FileMosaic key={ind} {...file} preview />
                    ))}
                  </Dropzone>
                </label>
              </div>
              ...
              <Map height={300} defaultCenter={[19.639484,-158.311505]} center={location ?? [19.639484,-158.311505]} defaultZoom={6}>
